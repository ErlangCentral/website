	...
	<div class="row">
		<div class="col-lg-6 col-md-6">
			...
			<div class="form-group ">
				<label class="control-label" for="erlang_since">{_ Using Erlang since _}</label>
				<input class="form-control" id="erlang_since" type="text" name="erlang_since" value="{{ r.erlang_since }}">
			</div>
		</div>
		...
		<div class="col-lg-6 col-md-6">
			...
			<div class="form-group address_github">
				<label class="control-label" for="github">{_ Github _}</label>
				<input class="form-control" id="github" type="text" name="github" value="{{ r.github }}">
			</div>
		</div>
	</div>
	<div class="row">
