{% with
    ...
    showmore_button_text|default:"Show more results...",
...
%}
    ...
    {% if items or default_items and id == m.acl.user %}
        {% if show_pager %}
        ...
        {% elseif not hide_showmore_button %}
            ...
            <div id="{{ list_id }}-buttons" class="list__more-nav">
                ...
                {% if not hide_showmore_button %}
                    {% button class="link" text=showmore_button_text action={moreresults result=result
                        target=list_id
